...
void manCmd(char *instruction, const char **cmds, uint8_t isInsideBash) {
    ...
    if (strcmp(instruction, cmds[0]) == 0) //! clear
        ...
        printf(
            ...
            "\nNumeric systems:\n"
            "\tBinaries (prefix: 0b)       : base 2 numbers e.g. 0b010000000000 = 1024\n"
            "\tOctal (prefix: 0)           : base 8 numbers e.g. 02000 = 1024\n"
            "\tDecimal (default)           : base 10 numbers e.g. 1024\n"
            "\tHexadecimals (prefix: 0x)   : base 16 numbers e.g. 0x400 = 1024\n"
        );
